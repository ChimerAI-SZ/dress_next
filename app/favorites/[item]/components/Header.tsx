...
const Header: React.FC<CollectionDetailHeaderProps> = ({ handleIconClick, collectionId, selectMode, handleSetSelectMode }) => {
          ...
          <Show when={!collectionList.find((item: any) => item.collection_id + "" === collectionId)?.is_default}>
            ...
            >
              ...
              <MenuContent border={"1px solid #bfbfbf"} borderRadius={"8pt"} backdropFilter={"blur(3px)"} bgColor={"rgba(255,255,255,0.8)"}>
                <FavouritesDialog type="edit" collectionId={collectionId}>
