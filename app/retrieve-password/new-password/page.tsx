  ...
  return (
    <VStack align="stretch" minH="100vh" p={3} px={5}>
      <DialogRoot open={open} placement={"center"} motionPreset="slide-in-bottom">
        <DialogContent width="18.44rem" height="10.69rem" background="#FFFFFF" borderRadius="0.75rem">
          <Flex flexDirection={"column"} alignItems={"center"} justifyContent={"center"}>
            <Text fontWeight="500" fontSize="1.06rem" color="#171717" textAlign={"center"} mt={"1.44rem"}>
              Congratulations
            </Text>
            <Text fontWeight="400" fontSize="0.88rem" color="#171717" textAlign={"center"} mt={"0.38rem"} px={"1.5rem"}>
        ...
        <VStack pb="4rem" w="100%" mt={"2.1rem"} pl={"0.25rem"}>
          <Fieldset.Root w="100%">
            <Fieldset.Content w="100%">
              {/* 密码输入框 */}
              <Field label="New Password" fontSize="0.75rem" fontWeight="400" invalid={!!errors.password}>
                ...
                <Flex alignItems={"center"} gap={"0.56rem"} mt={"0.7rem"}>
                  ...
                  <Text fontWeight="400" fontSize="0.81rem" color={isLengthValid ? "#299E46" : "#737373"}>
                ...
                <Flex alignItems={"center"} gap={"0.56rem"}>
                  ...
                  <Text fontWeight="400" fontSize="0.81rem" color={isUppercaseValid ? "#299E46" : "#737373"}>
                ...
                <Flex alignItems={"center"} gap={"0.56rem"}>
                  ...
                  <Text fontWeight="400" fontSize="0.81rem" color={isNumberValid ? "#299E46" : "#737373"}>
                    At least 1 number
                  </Text>
                </Flex>
              </Field>
                ...
                <InputGroup w="100%" bg={!!errors.newPassword ? "#ffe0e0" : ""}>
                  <Input
                    {...register("newPassword", {
                      ...
                      validate: value => value === password || "Passwords must match" // 验证密码是否一致
                    })}
                    flex="1"
                    name="newPassword"
                    type="password"
